        ...
        <section id="services" class="py-12 md:py-16 lg:py-20 bg-gray-50">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
                    ...
                    <!-- Layanan 1 -->
                    <div class="bg-white rounded-xl shadow-md hover:shadow-lg p-6 md:p-8 transform hover:-translate-y-2 transition-all duration-300">
                        <div class="text-blue-600 mb-5">
                            <svg class="w-10 h-10 md:w-12 md:h-12 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z"></path>
                            </svg>
                        </div>
                        <h3 class="text-lg md:text-xl font-semibold mb-3 text-gray-800">Pemasangan Profesional</h3>
                        <p class="text-gray-600 text-sm md:text-base">Tim ahli kami siap memasang sistem CCTV dan pagar otomatis dengan cepat dan rapi.</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md hover:shadow-lg p-6 md:p-8 transform hover:-translate-y-2 transition-all duration-300">
                        ...
                        <p class="text-gray-600 text-sm md:text-base">Layanan perawatan berkala dan perbaikan cepat untuk memastikan sistem Anda selalu optimal.</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md hover:shadow-lg p-6 md:p-8 transform hover:-translate-y-2 transition-all duration-300">
                        <div class="text-blue-600 mb-5">
                            <svg class="w-10 h-10 md:w-12 md:h-12 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 5.636l-3.536 3.536m0 0a3 3 0 10-4.243 4.243M15.536 17.536a3 3 0 104.243-4.243m-4.243 4.243L12 10.464m-4.243 4.243L5.636 18.364m0 0a3 3 0 104.243 4.243M5.636 18.364L10.464 12m4.243-4.243L18.364 5.636m-4.243-4.243a3 3 0 10-4.243 4.243m4.243-4.243L12 3.536m-4.243 4.243L5.636 1.636"></path>
                            </svg>
                        </div>
                        <h3 class="text-lg md:text-xl font-semibold mb-3 text-gray-800">Konsultasi Keamanan</h3>
                        <p class="text-gray-600 text-sm md:text-base">Dapatkan saran ahli untuk merancang sistem keamanan yang paling sesuai dengan kebutuhan Anda.</p>
                    </div>
                    
                    <!-- Layanan 4 (Tambahan untuk xl screen) -->
                    <div class="bg-white rounded-xl shadow-md hover:shadow-lg p-6 md:p-8 transform hover:-translate-y-2 transition-all duration-300 hidden xl:block">
                        <div class="text-blue-600 mb-5">
                            <svg class="w-10 h-10 md:w-12 md:h-12 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="text-gray-600 text-sm md:text-base">Monitoring dan dukungan teknis tersedia 24 jam untuk keamanan tanpa henti.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container mx-auto px-4 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    <div class="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow relative">
                        @if ($paket->is_popular)
                            <span class="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-blue-500 text-white px-4 py-1 rounded-full text-sm font-semibold">
                                Terpopuler
                            </span>
                        @endif
                        ...
                        <button class="w-full bg-blue-600 text-white py-3 rounded-full hover:bg-blue-700 transition-colors">
                            Pilih Paket
                        </button>
                    </div>
                </div>
                            ...
                            <div class="p-6">
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-800 group-hover:text-blue-600 dark:text-gray-200 dark:group-hover:text-blue-400">
                                            {{ $category->name }}
                                        </h3>
                                    </div>
