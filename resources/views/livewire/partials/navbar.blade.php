        ...
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                <a class="flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="/" aria-label="Brand">Dhefaka Associate</a>
                <div class="md:hidden">
                    <button type="button"
                        ...
                        @auth
                            ...
                            <div x-data="{ open: false }" class="relative">
                                ...
                                <div x-show="open" @click.outside="open = false" x-transition
                                    class="fixed right-0 z-10 mt-2 w-48 bg-white md:shadow-md rounded-lg p-2 dark:bg-gray-800 md:dark:border border dark:border-gray-700 dark:divide-gray-700"
                                    style="display: none;">
                                    <a href="/my-orders"
                                        class="block py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                                        Pesanan Saya
                                    </a>
                                    <a href="/my-profile"
                                        class="block py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
