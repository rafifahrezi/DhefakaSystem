              ...
              <tbody>
                ...
                @php
                    ...
                    if ($order->status == 'delivered') {
                      $status = '<span class="bg-green-700 py-1 px-3 rounded text-white shadow">Delivery</span>';
                    }
                    ...
                    if ($order->payment_status == 'paid') {
                      $payment_status = '<span class="bg-green-600  00 py-1 px-3 rounded text-white shadow">Paid</span>';
                    }
                    if ($order->payment_status == 'failed') {
                      $payment_status = '<span class="bg-red-600  00 py-1 px-3 rounded text-white shadow">Failed</span>';
                    }
                @endphp
